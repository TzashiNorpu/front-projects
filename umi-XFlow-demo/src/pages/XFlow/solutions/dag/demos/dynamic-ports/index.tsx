 ...
 * title: 动态更新节点链接桩逻辑
 * desc: |
 *  在config-graph.tsx 通过绑定联线的事件来动态增加和删除链接桩 <br>
 *  事件绑定逻辑实现在config-graph.tsx文件中。
 */
...
export const DAGDPDemo: React.FC<IProps> = props => {
  const { meta } = props
...
export default DAGDPDemo

DAGDPDemo.defaultProps = {
