 ...
 * title: 自定义连线逻辑
 * desc: |
 *  在config-graph.tsx 中可以定义validateConnection，validateMagnet两个X6的配置项来控制连线的逻辑 <br>
 */
...
export const DAGPortDemo: React.FC<IProps> = props => {
  const { meta } = props
...
export default DAGPortDemo

DAGPortDemo.defaultProps = {
