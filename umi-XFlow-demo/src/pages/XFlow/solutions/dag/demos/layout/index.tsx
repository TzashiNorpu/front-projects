 ...
 * title: 画布布局
 * desc: |
 *  DagGraphExtension 支持 layout connector router 等配置 <br>
 */
...
export const DAGLayoutDemo: React.FC<IProps> = props => {
  const { meta } = props
...
export default DAGLayoutDemo

DAGLayoutDemo.defaultProps = {
